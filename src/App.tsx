          ...
          <Route
            ...
            element={
              <>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                      <div className="space-y-6">
                        ...
                        <p className="text-xl text-gray-600">
                          Stammisar på ICA får en rabatt på boräntan som baseras på hur mycket du handlar på ICA. Kort sagt, när du handlar på ICA får du billigare bolån.
                        </p>
                  ...
                  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="bg-white rounded-lg shadow-lg p-8">
                      ...
                      <p className="text-lg mb-6">
                        Stammisar på ICA som köper ICA Försäkrings <strong>kattförsäkring</strong> får en extra bonus på <strong>250 kronor</strong> att handla för på ICA eller Apotek Hjärtat. Köper du en <strong>hundförsäkring</strong>, får du <strong>400 kronor</strong> i extra bonus.
                      </p>
                ...
                {/* ICA Jerry's 20th Anniversary Section */}
                <section className="bg-white py-16 text-center">
                  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <img
                      src="https://samhall.se/wp-content/uploads/2020/12/Story-2-20-ica-jerry-1024x576.jpg"
                      alt="ICA Jerry"
                      className="mx-auto mb-6 rounded-lg shadow-lg cursor-pointer"
                      onClick={handleImageClick} // Trigger modal on click
                    />
                    <h2 className="text-3xl font-bold text-gray-900">ICA Jerry Logistikchef - 20 År!</h2>
                    <p className="text-xl text-gray-600 mt-4">Vi firar 20 år med ICA Jerry och hans hårda arbete </p>
                  </div>
                </section>
                  ...
                  <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="relative w-full max-w-4xl">
                      ...
                      <iframe
                        width="100%"
                        height="600"
                        src="https://www.youtube.com/embed/GMgsFZ4rkEI?autoplay=1"
                        title="ICA Jerry Video"
                        frameBorder="0"
